...
public class Laberinto {
	...
	public static void main(String[] args) {
		...
		sacaVentana(l);  // Visualización
		
		l.entra();    
		mostrarLab(l, "Inicio", true);  // Visualización
	...
	private static boolean resuelveLaberinto(Laberinto l) {
		...
		while ((dir = l.posibleMovimiento()) != null) {
			...
			l.mueve(dir);         
			mostrarLab(l, "Mueve " + dir, true); // Visualización
			...
			mostrarLab(l, "Backtrack " + dir.dirOpuesta(), true); // Visualización
		}
