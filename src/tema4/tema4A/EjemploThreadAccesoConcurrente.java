...
// Prueba a quitar la palabra synchronized para ver que el array termina
// con números mayores que 1 ya que varios threads modifican "simultaneamente"
// la misma posición.
public class EjemploThreadAccesoConcurrente {
    ...
    static class Registry {
        ...
        // hilos no puedan intentar modificar la misma posición "a la vez"
        // realmente lo que ocurre es que leen el mismo 0 y los dos hilos
        // piensan que la posición está libre, ya que ninguno a terminado
        // todavía de modificar el valor a 1 para marcarla como ocupada
